...
<!-- jsp:include 는 JSP 에 포함하여 컴파일 하지 않고 별도의 서블릿 (OR JSP) 에 요청을 전달하는 것  -->
<jsp:include page="/WEB-INF/views/includes/nav.jsp"/>	

	<!-- <h3>Static HTML Page</h3>
	<p>이것은 정적HTML로 작성된 페이지입니다</p> -->
	
	<!-- img 태그: 그림삽입 -->
	<!-- src: 이미지의 위치, alt: 대체 텍스트 -->
	<!-- Stylesheet라는 기능을 사용하여 이미지 꾸미는 작업 -->
	<img src="images/google-css-images.jpg" 
			width = 320
			height=240
			alt="프로필"/>
	<h3>요청 처리 연습</h3>
	<p>
		<!-- a태그 : 페이지 링크 -->
		<a href="hello.jsp?name=Servlet">JSP 호출(GET방식)</a>
	</p>
	<p>
		<a href="hs?name=Servlet">Servlet 호출 (GET방식)</a>
	</p>
